...
public class ResourceCategoryController {
    @Autowired
    private TResourceCategoryService resourceCategoryService;

    @ApiOperation("查询所有后台资源分类")
    @RequestMapping(value = "/listAll", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<List<TResourceCategory>> listAll() {
        List<TResourceCategory> resourceList = resourceCategoryService.listAll();
    ...
    @ResponseBody
    public CommonResult create(@RequestBody TResourceCategory resourceCategory) {
    ...
    public CommonResult update(@PathVariable Long id,
                               @RequestBody TResourceCategory resourceCategory) {
